...
description: >-
  Designer's eye plan review — rate design dimensions 0-10, explain what a 10 looks like, then fix to get there.
  Use when reviewing UI/UX plans, screen designs, user flows, accessibility, or interaction states before implementation.
---
