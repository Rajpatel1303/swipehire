...
description: >-
  Post-ship documentation update — sync all project docs to match what was just shipped.
  Use when asked to document a release, sync documentation, or update project docs after shipping code.
---
