...
description: >-
  Engineering-level plan review — lock architecture, data flow, edge cases, tests.
  Use when validating technical architecture, data flow, error paths, and test coverage before writing code.
---
