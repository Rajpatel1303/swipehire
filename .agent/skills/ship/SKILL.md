...
name: ship
description: >-
  Automated release workflow — sync main, run tests, audit coverage, push, open PR.
  Use when shipping a release, preparing PRs, verifying test coverage before release, or executing automated shipping procedures.
---
